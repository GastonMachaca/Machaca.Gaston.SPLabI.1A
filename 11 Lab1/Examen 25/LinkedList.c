...
int ll_remove(LinkedList* this,int index)
{
    ...
    if(this != NULL && index >= 0 && index < size && size > 0)
       {
            if(index == 0)
            {
                ...
                {
                   before = getNode(this, index - 1);
                   auxNode = before->pNextNode;
                   before->pNextNode = auxNode->pNextNode;
                }
            free(auxNode);
            this->size--;
            returnAux = 0;
...
int ll_sort(LinkedList* this, int (*pFunc)(void* ,void*), int order)
{
    ...
    do
    {
        ...
        for(i = 0 ; i < ll_len(this)-1;i++)
        {
            ...
            if((pFunc(auxElemento,auxElemento2)>0 && order) || (pFunc(auxElemento,auxElemento2)<0 && !order))
            {
